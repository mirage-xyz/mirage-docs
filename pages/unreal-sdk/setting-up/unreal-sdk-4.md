...
1. Inside the **Unreal Project Browser**, select **Games** and click **Next**
   ...
   <img src="/docs/gaming/v4-games-2.png" alt="blank" class="responsive-pic" width="500" />
...
2. On the **Template** screen, select **Blank** and click **Next**
    ...
    <img src="/docs/gaming/game-template.png" alt="blank" class="responsive-pic" width="500" />
...
* From the **Desktop/Console** or **Mobile** options, select your preference. 
    ...
    <img src="/docs/gaming/game-v4-2.png" alt="blank" class="responsive-pic" width="500" />
